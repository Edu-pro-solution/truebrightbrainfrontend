  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <ListChecks className="h-6 w-6 text-[#180154]" />
        <div>
          <h2 className="text-2xl font-bold text-[#180154]">Exam List</h2>
          <p className="text-sm text-slate-500">
            Scheduled academic examinations
          </p>
        </div>
      </div>
          ...
          <Table>
            <TableHeader className="bg-[#E8EBF3]">
              <TableRow>
                ...
                <TableHead className="font-bold text-[#180154]">Date</TableHead>
                <TableHead className="font-bold text-[#180154]">
                  Comment
                </TableHead>
              </TableRow>
