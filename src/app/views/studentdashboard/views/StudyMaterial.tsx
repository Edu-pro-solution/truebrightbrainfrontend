    ...
    axios
      ...
      .then(({ data }) => {
        ...
        const classFiltered = className
          ? all.filter(
              (m) =>
                String(m.className || "").toLowerCase() ===
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <BookCopy className="h-6 w-6 text-[#180154]" />
        <div>
          <h2 className="text-2xl font-bold text-[#180154]">Study Materials</h2>
          <p className="text-sm text-slate-500">
            Download materials shared by your teachers
          </p>
        </div>
      </div>
          ...
          <Table>
            <TableHeader className="bg-[#E8EBF3]">
              <TableRow>
                ...
                <TableHead className="font-bold text-[#180154] text-right pr-6">
                  Download
                </TableHead>
              </TableRow>
            </TableHeader>
                    ...
                    <TableCell className="text-right pr-6">
                      {m.Downloads || m.fileUrl || m.url ? (
                        <Button
                          ...
                          <a
                            href={m.Downloads || m.fileUrl || m.url}
                            target="_blank"
