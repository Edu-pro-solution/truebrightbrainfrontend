  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-6 sm:p-8">
      <div className="mb-6 sm:mb-8">
        <h2 className="text-2xl font-bold text-[#180154] sm:text-3xl">
          On-Screen Marking
        </h2>
        ...
        {options.map((opt) => (
          <Card
            ...
            <CardHeader>
              ...
              <CardTitle className="text-[#180154]">{opt.title}</CardTitle>
              <CardDescription>{opt.description}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center text-sm font-semibold text-[#180154]">
