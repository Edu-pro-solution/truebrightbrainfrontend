  ...
  return (
    <div className="space-y-6 p-4">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-[#180154]">Exam Grades</h2>
        ...
        <CardContent className="p-0">
          <Table>
            <TableHeader className="bg-[#E8EBF3]">
              <TableRow>
                <TableHead className="text-[#180154] font-bold pl-6">
                  S/N
                </TableHead>
              ...
              {listLoading ? (
                ...
                currentGrades.map((grade, index) => (
                  <TableRow key={grade._id} className="hover:bg-slate-50/50">
                    ...
                    <TableCell className="text-center font-bold text-[#180154]">
                      {grade.grade_name ?? "—"}
                    </TableCell>
