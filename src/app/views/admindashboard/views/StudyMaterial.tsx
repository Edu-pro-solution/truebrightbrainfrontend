            ...
            <Select
              ...
              <SelectContent>
                {subjects.map((item) => (
                  <SelectItem
                    key={String(item._id ?? item.id ?? item.name)}
                    value={String(item.subjectName ?? item.name ?? "")}>
    ...
    <div className="space-y-6 p-4">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        ...
        <Button
          ...
          className="bg-[#180154] hover:bg-[#180154]/90 gap-2 font-semibold">
        ...
        <CardContent className="p-0">
          <Table>
            <TableHeader className="bg-[#E8EBF3]">
              <TableRow>
                <TableHead className="w-[60px] text-[#180154] font-bold pl-6">
                  S/N
                </TableHead>
                <TableHead className="text-[#180154] font-bold">Date</TableHead>
                    ...
                    <TableCell className="text-center">
                      {item.Downloads ? (
                        <Button
                          size="sm"
                          asChild
                          className="bg-[#180154] hover:bg-[#180154]/90 gap-2 h-8 px-4">
                          <a
                            href={item.Downloads}
                            target="_blank"
