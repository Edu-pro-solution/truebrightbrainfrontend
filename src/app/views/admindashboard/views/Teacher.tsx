  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (view === "add") {
        ...
        await axios.put(
          `${apiUrl}/api/teachers/${selectedTeacher._id}`,
          {
            username: form.name,
            email: form.email,
            phone: form.phone,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-row gap-4 justify-between items-center">
        <h2 className="text-2xl font-bold text-[#180154]">Manage Teachers</h2>
        <Button
          onClick={() => {
            setForm({
              name: "",
          ...
          className="bg-[#180154] gap-2 hover:bg-[#180154]/90">
            ...
            <TableBody>
              {listLoading ? (
                ...
                <TableRow>
                  <TableCell
                    ...
                    Failed to load teachers. Ensure a session is selected and
              ...
              {!listLoading &&
                ...
                currentTeachers.map((teacher, index) => (
                  <TableRow
                    key={
                      (teacher._id as string) || (teacher.id as string) || index
                    }
